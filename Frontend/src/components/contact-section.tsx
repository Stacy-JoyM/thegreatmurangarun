      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-8 sm:py-20">
        <div className="grid gap-8 md:grid-cols-[1.4fr_1fr_1fr] md:gap-16">
          ...
          <div className="rounded-sm border border-white/10 bg-white/5 p-5 sm:border-0 sm:bg-transparent sm:p-0">
            ...
            <div className="mt-6 inline-flex items-center gap-2 rounded-sm bg-[color:var(--yellow)] px-4 py-2">
              <span className="h-2 w-2 rounded-full bg-[color:var(--green)]" />
              <span className="text-[11px] font-bold uppercase tracking-[0.16em] text-[color:var(--green)]">
          ...
          <div className="rounded-sm border border-white/10 bg-white/5 p-5 sm:border-0 sm:bg-transparent sm:p-0">
            ...
            <ul className="mt-5 space-y-4 text-sm text-white/80">
              ...
              <li className="flex min-h-11 items-center gap-2.5">
                ...
                <a href="mailto:info@greatmurangacommunityrun.co.ke" className="inline-flex min-h-11 items-center break-all transition hover:text-white">
        ...
        {/* Bottom bar */}
        <div className="mt-10 flex flex-col items-start gap-2 border-t border-white/15 pt-6 sm:mt-14 sm:flex-row sm:items-center sm:justify-between">
